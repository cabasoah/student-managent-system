...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'CugManagementSystem') }}</title>

        <link rel="shortcut icon" href="{{asset('favicon_io/fav.jpeg')}}">
        <link rel="shortcut icon" sizes="16x16" href="{{asset('favicon_io/fav.jpeg')}}">
        <link rel="shortcut icon" sizes="32x32" href="{{asset('favicon_io/fav.jpeg')}}">
        ...
        <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0" style="align-items: center;">
                    <img src="{{asset('imgs/cug_logo_new1.png')}}"  height="90" srcset="">
                </div>

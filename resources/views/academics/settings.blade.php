...
<script>
    function getSectionsAndCourses(obj) {
        ...
        .then(function(data) {
            ...
            // console.log(typeof data.courses, data.courses);
            data.courses.data.unshift({'id': 0,'course_name': 'Please select a course'})
            data.courses.data.forEach(function(course, key) {

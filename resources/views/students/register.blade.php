            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-person-lines-fill"></i> Register as Student
                    </h1>

                    @include('session-messages')

                    <p class="text-primary">
                        <small><i class="bi bi-exclamation-diamond-fill me-2"></i> Remember to select related "Class" and "Section" before register</small>
                    </p>
                    <div class="mb-4">
                        <form class="row g-3" action="{{route('student.invite.create')}}" method="POST">
                            @csrf
                            <div class="row g-3">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputCity" name="city" placeholder="Accra..." required value="{{old('city')}}">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputNationality" name="nationality" placeholder="e.g. Ghanaian, German, ..." required value="{{old('nationality')}}">
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row mt-4 g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputFatherPhone" name="father_phone" placeholder="+233 01......" required value="{{old('father_phone')}}">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputMotherPhone" name="mother_phone" placeholder="+233 01......" required value="{{old('mother_name')}}">
                                </div>
                                <div class="col-4-md">
                            ...
                            <div class="row mt-4 g-3">
                                ...
                                <div class="col-md-12">
                                    <label for="inputBoardRegistrationNumber" class="form-label">Board registration No.(Use Index Number)</label>
...
<script>
    function getSections(obj) {
        ...
        var url = "{{route('invite.sections')}}?class_id=" + class_id 
        console.log(url);

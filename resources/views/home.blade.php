                    ...
                    <div class="row align-items-md-stretch mt-4">
                        <div class="col">
                            <div class="p-3 text-white bg-dark rounded-3">
                                <h3>Hello! Welcome {{Auth::user()->first_name}} {{Auth::user()->last_name}}</h3>
                                <p><i class="bi bi-emoji-heart-eyes"></i> to your dashboard.</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="p-3 bg-white border rounded-3" style="height: 100%;">
                                <h3>Seamlessly Manage students activities</h3>
                                {{-- <p class="text-end">with <i class="bi bi-lightning"></i> <a href="https://github.com/changeweb/Unifiedtransform" target="_blank" style="text-decoration: none;"></a> <i class="bi bi-lightning"></i>.</p> --}}
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
